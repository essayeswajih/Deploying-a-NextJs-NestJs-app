...
export async function GET(request: NextRequest) {
  try {
    ...
    // Simuler les données pour notifications
    const mockData = generateMockData('notifications');
    
    console.log('✅ Données simulées retournées pour notifications:', mockData.length || 'N/A');
